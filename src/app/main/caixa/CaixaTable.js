...
import CaixaTablePaginationActions from './CaixaTablePaginationActions';
  ...
  return (
    <div className="flex flex-col min-h-full sm:border-1 sm:rounded-16 overflow-hidden">
            ...
            {headerGroups.map((headerGroup, i) => (
              <TableRow key={i} {...headerGroup.getHeaderGroupProps()}>
                {headerGroup.headers.map((column, ind) => (
                  <TableCell
                    key={ind}
                    className="whitespace-pre-line p-4 md:p-12"
                    {...(!column.sortable
      ...
      <TablePagination
        ...
        ActionsComponent={CaixaTablePaginationActions}
      />
    </div>
  );
};
