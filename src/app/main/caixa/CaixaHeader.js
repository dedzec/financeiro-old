    ...
    <div className="flex flex-1 items-center justify-between p-4 sm:p-24">
        ...
        <ThemeProvider theme={mainTheme}>
          ...
          >
            ...
            <Input
              ...
              onChange={(ev) => dispatch(setCaixaSearchText(ev))}
            />
          </Paper>
        </ThemeProvider>
      </div>
      ...
      >
        ...
        <Button
          ...
          variant="contained"
          color="primary"
          onClick={() => dispatch(openListDialog())}
        >
          <span className="hidden sm:flex">Gerar Listas</span>
          <span className="flex sm:hidden">Listas</span>
        </Button>
      </motion.div>
    </div>
  );
