...
import ReciboTablePaginationActions from './ReciboTablePaginationActions';

// const ReciboTable = ({ columns, data, onRowClick }) => {
const ReciboTable = ({ columns, data }) => {
  const {
    getTableProps,
    headerGroups,
    prepareRow,
  ...
  return (
    <div className="flex flex-col min-h-full sm:border-1 sm:rounded-16 overflow-hidden">
      ...
      <TablePagination
        ...
        ActionsComponent={ReciboTablePaginationActions}
      />
    </div>
  );
};

ReciboTable.propTypes = {
