      ...
      >
        <FuseScrollbars className="p-16 sm:p-32">
          ...
          <Typography
            ...
            color="textSecondary"
          >
            * O esquema de cores selecionado será aplicado a todos os elementos
            de layout do tema (barra de navegação, barra de ferramentas, etc.).
            Você também pode selecionar uma cor diferente esquema para cada
            elemento de layout nas configurações do tema.
          </Typography>
