...
function NotificationPanel() {
  ...
  useEffect(() => {
    ...
    //       message: 'Ótimo trabalho! Isso é incrível.',
    ...
    //   () =>
    //     createNotification({
    //       // message: 'Hey there is a problem!',
    //       message: 'Ei, há um problema!',
    ...
    //       message: 'Pode haver um problema aqui!',
    ...
    //       message: 'Estas são algumas informações gerais.',
      ...
      {notifications.length > 0 ? (
        ...
        <div className="flex flex-1 items-center justify-center p-16">
          <Typography className="text-24 text-center" color="textSecondary">
            ...
            Não há notificações por enquanto.
          </Typography>
        </div>
      )}
    </SwipeableDrawer>
